    ...
    describe('Events', function () {
      it('Should emit an event on bridge', async function () {
        ...
        await expect(
          ...
          .withArgs(...[otherAccount.address, cometProvider.address, hre.ethers.ZeroAddress, amount, metadata])
        ...
        await expect(
          ...
          .to.emit(bridge, 'Bridged')
          .withArgs(...[otherAccount.address, cometProvider.address, token.getAddress(), amount, metadata])
